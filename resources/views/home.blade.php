...
@section('contents')
        <!--hero section start-->
        <section class="hero-section ptb-120 bg-dark text-white" style="background: url('{{ asset('assets/img/shape/dot-dot-wave-shape.svg')}}')no-repeat bottom left">
            <div class="container">
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-xl-5 col-lg-5">
                        <div class="hero-content-wrap text-center text-xl-start text-lg-start mt-5 mt-lg-0 mt-xl-0" data-aos="fade-up">
                            ...
                            <p class="lead">Need a software solution that’s right for you? Choose a digital product crafted to answer the challenges of your industry. Empower your business with a state-of-the-art digital solution, tailored to your needs and expectations.</p>
                            <div class="hero-subscribe-form-wrap pt-4 position-relative m-auto m-xl-0 d-none d-md-block d-lg-block d-xl-block">
                                ...
                                <ul class="nav subscribe-feature-list mt-3 justify-content-lg-start justify-content-md-center">
                                    <li class="nav-item">
                                        <span class="ms-0"><i class="far fa-check-circle text-primary me-2"></i>In-house Development</span>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <div class="hero-img-wrap position-relative" data-aos="fade-up">
                            <div class="hero-screen-wrap">
                                <div class="phone-screen">
                                    <img src="{{ asset('assets/img/screen/phone-screen.png')}}" alt="hero image" class="position-relative img-fluid">
                                </div>
                                <div class="mac-screen">
                                    <img src="{{ asset('assets/img/screen/mac-screen.png')}}" alt="hero image" class="position-relative img-fluid rounded-custom">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-12">
                        <ul class="customer-logos-grid text-center list-unstyled mb-0">
                            <li>
                                <img src="{{ asset('assets/img/clients/client-logo-1.svg')}}" width="150" alt="clients logo" class="img-fluid customer-logo p-1 p-md-2 p-lg-3 m-auto" data-aos="fade-up" data-aos-delay="50">
                            </li>
                            <li>
                                <img src="{{ asset('assets/img/clients/client-logo-2.svg')}}" width="150" alt="clients logo" class="img-fluid customer-logo p-1 p-md-2 p-lg-3 m-auto" data-aos="fade-up" data-aos-delay="50">
                            </li>
                            <li>
                                <img src="{{ asset('assets/img/clients/client-logo-3.svg')}}" width="150" alt="clients logo" class="img-fluid customer-logo p-1 p-md-2 p-lg-3 m-auto" data-aos="fade-up" data-aos-delay="50">
                            </li>
                            <li>
                                <img src="{{ asset('assets/img/clients/client-logo-4.svg')}}" width="150" alt="clients logo" class="img-fluid customer-logo p-1 p-md-2 p-lg-3 m-auto" data-aos="fade-up" data-aos-delay="50">
                            </li>
                        </ul>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="promo-card-wrap promo-border-hover border border-2 bg-white rounded-custom p-5 mb-4 mb-lg-0 mb-md-4" data-aos="fade-up" data-aos-delay="50">
                            <div class="promo-card-info">
                                ...
                                <p class="mb-0">As evoton-software we consider to approach a simple software product vision statement, and then define a broad strokes plan that allows your software project to begin to move forward in small increments. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="promo-card-wrap promo-border-hover border border-2 bg-white rounded-custom p-5 mb-4 mb-lg-0 mb-md-4" data-aos="fade-up" data-aos-delay="100">
                            <div class="promo-card-info">
                                ...
                                <p class="mb-0">Evoton software allow developers to engage with the customer or end users directly, and freedom to make any changes that do not alter the scope of the project, goes a long way in empowering them and making them happy.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="promo-card-wrap promo-border-hover border border-2 bg-white rounded-custom p-5 mb-4 mb-lg-0 mb-md-0" data-aos="fade-up" data-aos-delay="150">
                            <div class="promo-card-info">
                                ...
                                <p class="mb-0">As evoton-software we support our customers and help them find answers to questions as soon as they come up—24/7 and in real-time. </p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-5 col-md-12">
                        <div class="section-heading" data-aos="fade-up">
                            ...
                            <p>As evoton-software we become more complex and demanding companies to opt in for custom software development as a solution to issues on many different fronts.
                                For one, evoton-software development gives your business the flexibility and compatibility to scale up or down and tailor it specifically to your needs.
                                With this info, let’s dive in and find out why evoton-software development might be the best solution for your business.</p>
                    ...
                    <div class="col-lg-6 col-md-7">
                        <div class="feature-img-wrap position-relative d-flex flex-column align-items-end">
                            ...
                            <img src="{{ asset('assets/img/feature-img3.jpg')}}" alt="feature image" class="img-fluid rounded-custom" data-aos="fade-up">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-lg-center justify-content-between">
                    <div class="col-lg-5 order-lg-2 mb-7 mb-lg-0">
                        <div class="mb-4" data-aos="fade-up">
                            ...
                            <p>Evoton Software creates a fantastic brand experience that inspires loyalty and advocacy underlying network and data integrations which brings companies together behind one unifying interest. </p>
                        </div>
                        <ul class="list-unstyled d-flex flex-wrap list-two-col mt-5" data-aos="fade-up" data-aos-delay="50">
                            <li>
                                ...
                                <p>Evoton-software is able to visualize customers journey and build individual customer profiles, gaining even deeper insights into each and every customer that has visited your store.</p>
                            </li>
                            <li>
                            ...
                            <div class="feature-card  bg-custom-light promo-border-hover border border-2 border-light text-white shadow-sm highlight-card rounded-custom p-5" data-aos="fade-up" data-aos-delay="50">
                                ...
                                <div class="feature-content">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li class="py-1"><i class="fad fa-check-circle me-2 text-primary"></i>Modernized prospecting</li>
                                        <li class="py-1"><i class="fad fa-check-circle me-2 text-primary"></i>Clean and modern</li>
                                        <li class="py-1"><i class="fad fa-check-circle me-2 text-primary"></i>Showcasing success</li>
                                        <li class="py-1"><i class="fad fa-check-circle me-2 text-primary"></i>Bootstrap latest version</li>
                                    </ul>
                                </div>
                        ...
                        <div class="integration-wrapper position-relative w-100">
                            ...
                            <ul class="position-absolute animate-element parallax-element shape-service z--1 d-none d-lg-none d-xl-block">
                                ...
                                <li class="layer" data-depth="0.02">
                                    <img src="{{ asset('assets/img/color-shape/feature-2.svg')}}" alt="shape" class="img-fluid position-absolute color-shape-2 z-5">
                                </li>
                            ...
                            <ul class="integration-list list-unstyled mb-0">
                                <li data-aos="fade-up" data-aos-delay="50">
                                    <div class="single-integration">
                                        <img src="{{ asset('assets/img/integations/figma.png')}}" alt="integration" class="img-fluid">
                                        <h6 class="mb-0 mt-4">Figma</h6>
                                    </div>
                                </li>
                                <li data-aos="fade-up" data-aos-delay="50">
                                    <div class="single-integration">
                                        <img src="{{ asset('assets/img/integations/facebook.png')}}" alt="integration" class="img-fluid">
                                        <h6 class="mb-0 mt-4">Facebook</h6>
                                    </div>
                                </li>
                                <li data-aos="fade-up" data-aos-delay="50">
                                    <div class="single-integration">
                                        <img src="{{ asset('assets/img/integations/sales-force.png')}}" alt="integration" class="img-fluid">
                                        <h6 class="mb-0 mt-4">Sales Force</h6>
                                    </div>
                                </li>
                                <li data-aos="fade-up" data-aos-delay="50">
                                    <div class="single-integration">
                                        <img src="{{ asset('assets/img/integations/atlassian.png')}}" alt="integration" class="img-fluid">
                                        <h6 class="mb-0 mt-4">Atlassian</h6>
                                    </div>
                                </li>
                                <li data-aos="fade-up" data-aos-delay="50">
                                    <div class="single-integration">
                                        <img src="{{ asset('assets/img/integations/dropbox-2.png')}}" alt="integration" class="img-fluid">
                                        <h6 class="mb-0 mt-4">DropBox</h6>
                                    </div>
                                </li>
                                <li data-aos="fade-up" data-aos-delay="100">
                                    <div class="single-integration">
                                        <img src="{{ asset('assets/img/integations/evernote.png')}}" alt="integration" class="img-fluid">
                                        <h6 class="mb-0 mt-4">EverNote</h6>
                                    </div>
                                </li>
                                <li data-aos="fade-up" data-aos-delay="100">
                                    <div class="single-integration">
                                        <img src="{{ asset('assets/img/integations/google-icon.png')}}" alt="integration" class="img-fluid">
                                ...
                                <li data-aos="fade-up" data-aos-delay="100">
                                    <div class="single-integration">
                                        <img src="{{ asset('assets/img/integations/slack.png')}}" alt="integration" class="img-fluid">
                                ...
                                <li data-aos="fade-up" data-aos-delay="100">
                                    <div class="single-integration">
                                        <img src="{{ asset('assets/img/integations/google-analytics.png')}}" alt="integration" class="img-fluid">
                                ...
                                <li data-aos="fade-up" data-aos-delay="150">
                                    <div class="single-integration">
                                        <img src="{{ asset('assets/img/integations/google-drive.png')}}" alt="integration" class="img-fluid">
                                ...
                                <li data-aos="fade-up" data-aos-delay="150">
                                    <div class="single-integration">
                                        <img src="{{ asset('assets/img/integations/hubspot.png')}}" alt="integration" class="img-fluid">
                                ...
                                <li data-aos="fade-up" data-aos-delay="150">
                                    <div class="single-integration">
                                        <img src="{{ asset('assets/img/integations/instagram.png')}}" alt="integration" class="img-fluid">
                                        <h6 class="mb-0 mt-4">Instagram</h6>
                                    </div>
                                </li>
                                <li data-aos="fade-up" data-aos-delay="150">
                                    <div class="single-integration">
                                        <img src="{{ asset('assets/img/integations/linkedin.png')}}" alt="integration" class="img-fluid">
                                        <h6 class="mb-0 mt-4">Linkedin</h6>
                                    </div>
                                </li>
                                <li data-aos="fade-up" data-aos-delay="150">
                                    <div class="single-integration">
                                        <img src="{{ asset('assets/img/integations/mailchimp.png')}}" alt="integration" class="img-fluid">
                                        <h6 class="mb-0 mt-4">MailChimp</h6>
                                    </div>
                                </li>
                                <li data-aos="fade-up" data-aos-delay="150">
                                    <div class="single-integration">
                                        <img src="{{ asset('assets/img/integations/marekto.png')}}" alt="integration" class="img-fluid">
